        ...
        if (activeMenu) {
          if (isPlaying) {
            ...
            if (activeMenu.id === 'about-me') {
              targetPos = new THREE.Vector3(-1.0, 2.5, 3.5);
              targetLook = new THREE.Vector3(1.2, 0.4, 0);
            } else if (activeMenu.id === 'experiences') {
              targetPos = new THREE.Vector3(1.0, 3.5, 2.5);
              targetLook = new THREE.Vector3(1.0, 0.2, 0);
            } else if (activeMenu.id === 'projects') {
              targetPos = new THREE.Vector3(0, 2.0, 4.0);
              targetLook = new THREE.Vector3(1.5, 0.4, 0);
            } else if (activeMenu.id === 'connect') {
              targetPos = new THREE.Vector3(-2.0, 3.0, 2.0);
              targetLook = new THREE.Vector3(1.5, 0.2, -1.0);
            } else {
              targetPos = new THREE.Vector3(0, 3.0, 3.5);
              targetLook = new THREE.Vector3(1.2, 0.4, 0);
            }
          } else {
